...
;datadir = '/z2/satellite/OMI/no2/DOMINO_S/collection3/2005/'
;fle_n = datadir+'OMI-Aura_L2-OMDOMINO_2005m0601t0039-o04671_v003-2008m0505t052643.he5'
...
;gc_file = '/z3/wangsiwen/GEOS_Chem/GEOS_05x0666/v9-01-01.standard.geos5.05x0667.intexb/ts_13_15.'+ymd+'.bpch'
endif else begin
gc_file = '/z3/wangsiwen/GEOS_Chem/GEOS_05x0666/GC_201012/ts_2h_avg.2007'+my_month + my_day +'.month.power.plant.bpch'
endelse

if (long(my_year) eq 2005 and long(my_month) eq 1) then begin
;gc_file = '/z3/wangsiwen/GEOS_Chem/GEOS_05x0666/GC_201012/ts_2h_avg.20050130.month.power.plant.bpch'
gc_file = '/z3/wangsiwen/GEOS_Chem/GEOS_05x0666/v9-01-01.standard.geos5.05x0667.meic.plus.ubpower/ts_13_15.'+ymd+'.bpch'
endif
